...
const normalize = (data) => {
    return data.reduce((accumulatorObj, obj_element) => {
      // Desestructurar el objeto en el objeto rest y extraer la propiedad 'id' en una constante id
      const { id, ...restObj } = obj_element;
  
      // Usar la 'id' como clave y el resto del objeto como valor
      accumulatorObj[id] = restObj;
